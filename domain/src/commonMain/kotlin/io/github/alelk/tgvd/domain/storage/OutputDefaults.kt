...
object OutputDefaults {
    ...
    val MUSIC_VIDEO: List<OutputRule> =
        listOf(
            OutputRule(
    ...
    fun defaultFor(category: Category): List<OutputRule> =
        when (category) {

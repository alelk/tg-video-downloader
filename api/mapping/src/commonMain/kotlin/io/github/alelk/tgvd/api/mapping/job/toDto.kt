...
fun Job.toDto(): JobDto = JobDto(
    ...
    source = source.toDto(),
    videoInfo = videoInfo?.toDto() ?: io.github.alelk.tgvd.api.contract.video.VideoInfoDto(
        videoId = source.videoId.value,
        extractor = source.extractor.value,
        title = metadata.title,
        channelId = "",
        channelName = "",
        durationSeconds = 0,
        webpageUrl = source.url.value,
    ),
